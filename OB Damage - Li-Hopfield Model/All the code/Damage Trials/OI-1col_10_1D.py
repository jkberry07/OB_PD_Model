...
#    Ndamagetotal = Nmitral*2 + 1  #number of damage steps
    Ndamage = 11 #number of steps to get to 100% damaged
...
#    P_odor3 = 4/700*np.array([.7,.8,.5,1.2,.7,1.2,.8,.7,.8,.8])
    ...
    dam[colnum] +=.1  #To start out with zero damage
...
#    Ncolumns = np.copy(Nmitral)
    ...
    dmgpct,eigfreq,d1,d2,d3,d4,pwr,IPR,IPR2,pn,freq,cell_act = dmg_seed_10_1D(arrayid)  
