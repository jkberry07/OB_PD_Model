...
frequencies = np.zeros(Nmatrices)
...
######################Start for each matrix###############################

for p in np.r_[0:Nmatrices]:
    flnameH = "H0_10_2D" + str(arrayid)
    flnameW = "W0_10_2D" + str(arrayid)
    ...
    H0_i = np.array([[.3,.9,0,0,.45,.45,0,0,0,.7],\
                     [.9,.4,1,0,0,.45,.45,0,0,0],\
                     [0,.8,.3,.8,0,0,.45,.45,0,0],\
                     [0,0,.7,.5,.9,0,0,.45,.45,0],\
                     [0,0,0,.8,.3,.8,0,0,.45,.45],\
                     [.45,0,0,0,.7,.3,.9,0,0,.45],\
                     [.45,.45,0,0,0,.7,.4,.9,0,0],\
                     [0,.45,.45,0,0,0,.5,.5,.7,0],\
                     [0,0,.45,.45,0,0,0,.9,.3,.9],\
                     [.9,0,0,.45,.45,0,0,0,.8,.3]])
...
#    H0[-1,0] = np.random.randint(7,11)/10
    ...
    H0[H0==.45] = np.random.uniform(size=np.shape(H0[H0==.45]))
    ...
    W0_i = np.array([[.3,.7,0,0,.35,.35,0,0,0,.3],\
                     [.3,.2,.5,0,0,.35,.35,0,0,0],\
                     [0,.1,.3,.5,0,0,.35,.35,0,0],\
                     [0,0,.2,.2,.5,0,0,.35,.35,0],\
                     [0,0,0,.5,.1,.9,0,0,.35,.35],\
                     [.35,0,0,0,.3,.3,.5,0,0,.35],\
                     [.35,.35,0,0,0,.2,.3,.5,0,0],\
                     [0,.35,.35,0,0,0,.5,.3,.5,0],\
                     [0,0,.35,.35,0,0,0,.2,.3,.7],\
                     [.7,0,0,.35,.35,0,0,0,.3,.5]])
    
    W0 = np.copy(W0_i)
    W0[W0==.35] = np.random.uniform(size=np.shape(W0[W0==.35]))
...
#    W0[-1,0] = np.random.randint(5,10)/10
    ...
    while pwr < .2 or IPR1 < 4:
        ...
        for i in np.arange(Nmitral):
            OsciAmp[i] = np.sqrt(np.sum(Shtrial[:,i]**2)/np.size(Shtrial[:,i]))
...
#        psi = psi/np.sqrt(np.sum(psi**2))
    ...
    print("actual frequency = ", f[argf[0][0]])
