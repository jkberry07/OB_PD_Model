...
submitname = 'submit_PD-seed_50_1D.sh'

f3 = open(submitname,'w+')

subdir1 = 'PD-seed_50_1D'

f3.write('cd '+subdir1+'\n')



jobname = 'PD-seed_50_1D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J PD_50_1D_%A\n')
f2.write('#SBATCH -o PD_50_1D_%A.txt\n')
f2.write('#SBATCH -e PD_50_1De_%A.txt\n')
...
f2.write('srun python PD-seed_50_1D.py')
