...
submitname = 'submit_OI-seed_10_2D.sh'

f3 = open(submitname,'w+')

subdir1 = 'OI-seed_10_2D'

f3.write('cd '+subdir1+'\n')



jobname = 'OI-seed_10_2D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J OI_10_2D_%A\n')
f2.write('#SBATCH -o OI_10_2D_%A.txt\n')
f2.write('#SBATCH -e OI_10_2De_%A.txt\n')
...
f2.write('srun python OI-seed_10_2D.py')
