...
submitname = 'submit_MC-flat_20_2D.sh'

f3 = open(submitname,'w+')

subdir1 = 'MC-flat_20_2D'

f3.write('cd '+subdir1+'\n')



jobname = 'MC-flat_20_2D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J MC_20_2D_%A\n')
f2.write('#SBATCH -o MC_20_2D_%A.txt\n')
f2.write('#SBATCH -e MC_20_2De_%A.txt\n')
...
f2.write('srun python MC-flat_20_2D.py')
