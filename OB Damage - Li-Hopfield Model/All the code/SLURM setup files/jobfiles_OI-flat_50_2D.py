...
submitname = 'submit_OI-flat_50_2D.sh'

f3 = open(submitname,'w+')

subdir1 = 'OI-flat_50_2D'

f3.write('cd '+subdir1+'\n')



jobname = 'OI-flat_50_2D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J OI_50_2D_%A\n')
f2.write('#SBATCH -o OI_50_2D_%A.txt\n')
f2.write('#SBATCH -e OI_50_2De_%A.txt\n')
...
f2.write('srun python OI-flat_50_2D.py')
