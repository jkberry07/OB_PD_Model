...
submitname = 'submit_OI-1col_20_1D.sh'

f3 = open(submitname,'w+')

subdir1 = 'OI-1col_20_1D'

f3.write('cd '+subdir1+'\n')



jobname = 'OI-1col_20_1D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J OI_20_1D_%A\n')
f2.write('#SBATCH -o OI_20_1D_%A.txt\n')
f2.write('#SBATCH -e OI_20_1De_%A.txt\n')
...
f2.write('srun python OI-1col_20_1D.py')
