...
submitname = 'submit_GC-1col_50_1D.sh'

f3 = open(submitname,'w+')

subdir1 = 'GC-1col_50_1D'

f3.write('cd '+subdir1+'\n')



jobname = 'GC-1col_50_1D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J GC_50_1D_%A\n')
f2.write('#SBATCH -o GC_50_1D_%A.txt\n')
f2.write('#SBATCH -e GC_50_1De_%A.txt\n')
...
f2.write('srun python GC-1col_50_1D.py')
