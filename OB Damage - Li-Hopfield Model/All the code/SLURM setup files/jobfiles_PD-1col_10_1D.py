...
submitname = 'submit_PD-1col_10_1D.sh'

f3 = open(submitname,'w+')

subdir1 = 'PD-1col_10_1D'

f3.write('cd '+subdir1+'\n')



jobname = 'PD-1col_10_1D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J PD_10_1D_%A\n')
f2.write('#SBATCH -o PD_10_1D_%A.txt\n')
f2.write('#SBATCH -e PD_10_1De_%A.txt\n')
f2.write('#SBATCH -t 2-00:00:00\n')
f2.write('#SBATCH --array=0-9\n')         
f2.write('#SBATCH --mail-type=all\n')
f2.write('#SBATCH --mail-user=jkberry@ucdavis.edu\n')
f2.write('module load bio3\n')
f2.write('srun python PD-1col_10_1D.py')
