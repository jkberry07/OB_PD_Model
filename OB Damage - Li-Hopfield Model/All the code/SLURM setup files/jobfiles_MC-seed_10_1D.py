...
submitname = 'submit_MC-seed_10_1D.sh'

f3 = open(submitname,'w+')

subdir1 = 'MC-seed_10_1D'

f3.write('cd '+subdir1+'\n')



jobname = 'MC-seed_10_1D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J MC_10_1D_%A\n')
f2.write('#SBATCH -o MC_10_1D_%A.txt\n')
f2.write('#SBATCH -e MC_10_1De_%A.txt\n')
...
f2.write('srun python MC-seed_10_1D.py')
