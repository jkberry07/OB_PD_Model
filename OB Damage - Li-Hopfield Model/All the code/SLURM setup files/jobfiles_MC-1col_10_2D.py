...
submitname = 'submit_MC-1col_10_2D.sh'
...
jobname = 'MC-1col_10_2D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J MC_10_2D_%A\n')
f2.write('#SBATCH -o MC_10_2D_%A.txt\n')
f2.write('#SBATCH -e MC_10_2De_%A.txt\n')
...
f2.write('srun python MC-1col_10_2D.py')
