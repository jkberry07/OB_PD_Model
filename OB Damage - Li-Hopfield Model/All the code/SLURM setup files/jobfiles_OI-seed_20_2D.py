...
submitname = 'submit_OI-seed_20_2D.sh'

f3 = open(submitname,'w+')

subdir1 = 'OI-seed_20_2D'

f3.write('cd '+subdir1+'\n')



jobname = 'OI-seed_20_2D.sh'
f2 = open(os.path.join(here,subdir1,jobname),'w+')
f2.write('#!/bin/bash -l\n')
f2.write('#SBATCH -J OI_20_2D_%A\n')
f2.write('#SBATCH -o OI_20_2D_%A.txt\n')
f2.write('#SBATCH -e OI_20_2De_%A.txt\n')
...
f2.write('srun python OI-seed_20_2D.py')
