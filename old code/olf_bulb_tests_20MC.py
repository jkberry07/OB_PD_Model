...
##Test the network on the constant odor, no noise condition
        
#soltest = solve_ivp(lambda t,y: testdiffeq(t,y,Nmitral,Ngranule,Ndim,lastnoise,\
#                noise,noisewidth,noiselevel, t_inh,t_exh,exh_rate,alpha,Sy,\
#                Sy2,Sx,Sx2,th,H0,W0,P_odor1,Ic,Ib),\
#                [0,finalt],init0,t_eval = teval,method = 'RK45') 
#
#ytest = soltest.y
...
#fig5 = plt.figure(5, figsize=(16,8.5))
#fig5.suptitle('OdE under constant odor, no noise condition')
#for i in np.arange(Nmitral):
#    plt.subplot(5,2,i+1)
#    plt.plot(t,youttest[:,i])
#for i in np.arange(Ngranule):
#    plt.subplot(5,2,i+1)
#    plt.plot(t,youttest[:,i+Nmitral])
